...
var authorsList = []*Author{
	{
		...
		Features: []string{"Data Engineer in Amazon, Alexa AI",
			"10+ years of experience in Analytics (Russia, Europe, Canada и USA)",
			"Organizer of Vancouver Tableau User Group, Snowflake Canada User Group, Amazon Tableau User Group и Amazon BI Tech Talks",
